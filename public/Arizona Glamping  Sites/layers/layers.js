...
var format_Not_Allowed_3 = new ol.format.GeoJSON();
var features_Not_Allowed_3 = format_Not_Allowed_3.readFeatures(json_Not_Allowed_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Not_Allowed_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Not_Allowed_3.addFeatures(features_Not_Allowed_3);cluster_Not_Allowed_3 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Not_Allowed_3
});
var lyr_Not_Allowed_3 = new ol.layer.Vector({
                declutter: true,
                source:cluster_Not_Allowed_3, 
                style: style_Not_Allowed_3,
                interactive: true,
                title: '<img src="styles/legend/Not_Allowed_3.png" /> Not_Allowed'
            });
var format_Allowed_4 = new ol.format.GeoJSON();
var features_Allowed_4 = format_Allowed_4.readFeatures(json_Allowed_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Allowed_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Allowed_4.addFeatures(features_Allowed_4);cluster_Allowed_4 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Allowed_4
});
var lyr_Allowed_4 = new ol.layer.Vector({
                declutter: true,
                source:cluster_Allowed_4, 
                style: style_Allowed_4,
                interactive: true,
                title: '<img src="styles/legend/Allowed_4.png" /> Allowed'
            });

lyr_OSMStandard_0.setVisible(true);lyr_Arizona_Boundary_1.setVisible(true);lyr_Arizona_Zones_2.setVisible(true);lyr_Not_Allowed_3.setVisible(true);lyr_Allowed_4.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Arizona_Boundary_1,lyr_Arizona_Zones_2,lyr_Not_Allowed_3,lyr_Allowed_4];
...
lyr_Not_Allowed_3.set('fieldAliases', {'Name': 'Name', 'Remarks': 'Remarks', });
lyr_Allowed_4.set('fieldAliases', {'Name': 'Name', 'Remarks': 'Remarks', });
...
lyr_Not_Allowed_3.set('fieldImages', {'Name': 'TextEdit', 'Remarks': 'TextEdit', });
lyr_Allowed_4.set('fieldImages', {'Name': 'TextEdit', 'Remarks': 'TextEdit', });
...
lyr_Not_Allowed_3.set('fieldLabels', {'Name': 'inline label', 'Remarks': 'inline label', });
lyr_Allowed_4.set('fieldLabels', {'Name': 'inline label', 'Remarks': 'inline label', });
lyr_Allowed_4.on('precompose', function(evt) {
